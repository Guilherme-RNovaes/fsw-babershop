            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <Sheet open={sheetIsOpen} onOpenChange={setSheetIsOpen}>
                ...
                <SheetContent className="p-0">
                  ...
                  <div className="py-6">
                    <Calendar mode="single" selected={date} onSelect={handleDateClick} fromDate={addDays(new Date(), 1)} locale={ptBR}
                      styles={{
                        head_cell: {
                          width: '100%',
                      ...
                      <CardContent className="p-3 gap-3 flex flex-col">
                        ...
                        {date && (
                          <div className="flex justify-between">
                            ...
                            <h4 className="text-sm capitalize">{format(date, "dd 'de' MMMM", { locale: ptBR })}</h4>
                          </div>
                        )}
                        {hour && (
                          <div className="flex justify-between">
                  ...
                  <SheetFooter className="px-5">
                    <Button disabled={(!hour || !date) || submitIsLoading} onClick={handleBookingSubmit}>
                      {submitIsLoading && <Loader2 className="mr-2 h-2 w-4 animate-spin" />}
                      Confirmar Reserva
                    </Button>
                  </SheetFooter>
                </SheetContent>
