          ...
          <Card>
            <CardContent className="p-3 gap-3 flex flex-col">
              ...
              <div className="flex justify-between">
                ...
                <h4 className="text-sm capitalize">{format(booking.date, "dd 'de' MMMM", { locale: ptBR })}</h4>
              </div>
              <div className="flex justify-between">
          ...
          <SheetFooter className="flex-row gap-3 mt-6">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button disabled={!isBookingConfirmed || isDeleatedLoading} className="w-full" variant="destructive">
                  Cancelar Reserva
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="w-[90%]">
                ...
                <AlertDialogFooter className="flex-row gap-3">
                  ...
                  <AlertDialogAction disabled={isDeleatedLoading} onClick={handleCancelClick} className="w-full">
                    {isDeleatedLoading && (
